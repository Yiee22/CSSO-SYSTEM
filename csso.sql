...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2025 at 02:15 PM
...
CREATE TABLE `student_profile` (
  ...
  `Section` enum('BSIT_1A','BSIT_1B','BSIT_2A','BSIT_2B','BSIT_3A','BSIT_3B','BSIT_4A','BSIT_4B','BSCS_1A','BSCS_1B','BSCS_2A','BSCS_2B','BSCS_3A','BSCS_3B','BSCS_4A','BSCS_4B') DEFAULT NULL,
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `username`, `password`, `usertype`, `date_in`, `time_in`) VALUES
(27, 'Randy', 'Salon', 'randy', '$2y$10$M1vblya/eXW49whP.lNBFeje/z8H1dGUEcaE1gN3SpzqgCpDjAYmm', 'Governor', '2025-10-11', '13:48:40');
...
ALTER TABLE `educational_background`
  ...
  ADD KEY `fk_student_edu` (`students_id`);
...
--
ALTER TABLE `student_profile`
  MODIFY `students_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `educational_background`
  ADD CONSTRAINT `fk_student_edu` FOREIGN KEY (`students_id`) REFERENCES `student_profile` (`students_id`) ON DELETE CASCADE ON UPDATE CASCADE;
