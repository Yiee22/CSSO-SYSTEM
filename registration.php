...
.header-bar h2 {
  color: #1e3a8a; font-weight: 700; display: flex; align-items: center; gap: 10px;
}
.header-bar h2 i { color: #1e3a8a; }
.list-btn {
  background: #1e3a8a; color: #fff; border: none; padding: 10px 18px;
...
/* RIGHT SIDE */
.summary {
  flex: 1; background: #000; border-radius: 12px; color: #fff;
